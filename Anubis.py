...
#        Port.addAction(Port_Action)
        ...
        ExecuteFunction = menu.addMenu('Run Function')
        ExecuteFunctionAction = QAction("ExecuteFunction", self)
        ExecuteFunctionAction.triggered.connect(self.ExecuteFunction)
        ExecuteFunction.addAction(ExecuteFunctionAction)
    ...
    def ExecuteFunction(self):
        ...
        if len(code) > 7 and code[0:4] == 'def ':
            ...
            text2.append(
                "please write a single function")
